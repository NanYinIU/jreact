...
import RendererWrapper0 from '/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/.umi/LocaleWrapper.jsx'
...
let routes = [
  ...
  LoadingComponent: require('/Users/gaoguoxing/Documents/code/ant-design-pro/src/components/PageLoading/index').default,
}),
    "routes": [
      {
        "path": "/user",
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__User__models__register.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/User/models/register.js').then(m => { return { namespace: 'register',...m.default}})
],
...
models: () => [
  ...
  LoadingComponent: require('/Users/gaoguoxing/Documents/code/ant-design-pro/src/components/PageLoading/index').default,
      ...
      {
        "component": () => React.createElement(require('/Users/gaoguoxing/Documents/code/ant-design-pro/node_modules/_umi-build-dev@1.5.5@umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Dashboard/models/activities.js').then(m => { return { namespace: 'activities',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Dashboard/models/chart.js').then(m => { return { namespace: 'chart',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Dashboard/models/monitor.js').then(m => { return { namespace: 'monitor',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Forms__models__form.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Forms/models/form.js').then(m => { return { namespace: 'form',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__List__models__rule.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/List/models/rule.js').then(m => { return { namespace: 'rule',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Profile__models__profile.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Profile/models/profile.js').then(m => { return { namespace: 'profile',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Exception__models__error.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Exception/models/error.js').then(m => { return { namespace: 'error',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Account__Settings__models__geographic.js' */'/Users/gaoguoxing/Documents/code/ant-design-pro/src/pages/Account/Settings/models/geographic.js').then(m => { return { namespace: 'geographic',...m.default}})
],
